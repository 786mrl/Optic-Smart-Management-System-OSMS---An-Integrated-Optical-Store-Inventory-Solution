...
$query = "SELECT ce.*, co.customer_number,
          ...
          LEFT JOIN customer_orders co
            ON ce.invoice_number = co.invoice_number
          WHERE ce.invoice_number = '$invoice_num' LIMIT 1";
$result = mysqli_query($conn, $query);

if (!$result) {
    die("<p style='padding:2rem;color:red;font-family:sans-serif;'>
            <b>SQL Error:</b> " . mysqli_error($conn) . "
         </p>");
}
...
.inv-num-val{font-size:12px;font-weight:500;color:#EF9F27;line-height:1;}
    ...
    <div class="inv-header">
        <div class="inv-header-top">
            ...
            <div class="inv-num-block">
                ...
                <div class="inv-num-val"><?php echo htmlspecialchars($data['customer_number'] ?? $data['invoice_number']); ?></div>
