    ...
    <head>
        ...
        <style>
            ...
            @media (max-width:600px) {
                .config-window   { padding:26px 8px 30px; box-sizing:border-box; }
                ...
                /* Group & Category: keep side-by-side, just shrink text so both fit.
                   The "Jump to Last Edited" button drops to its own row below them. */
                .filter-bar          { flex-direction:row; flex-wrap:wrap; gap:8px; padding:12px 10px; }
                .filter-bar label    { font-size:9px; margin-bottom:4px; }
                .filter-bar select   { font-size:11px; padding:8px 10px; }
                .filter-bar > div:nth-child(3) { flex:0 0 100% !important; order:3; margin-top:4px; display:flex; justify-content:center; }
                .filter-bar > div:nth-child(3) label { display:none; }
                .jump-last-btn       { width:100%; justify-content:center; }

                .lens-prices-row { flex-direction:column; }

                /* Price list card: more inner breathing room so content doesn't spill out */
                .lens-card             { padding:40px 14px 34px; }
                .lens-card.collapsed   { padding:26px 14px 26px 18px; }
                .lens-card-body        { padding:10px 0 8px; }

                /* Add New Lens card: same extra inner gap as the price list card */
                .add-form-card   { padding:30px 16px 26px; }
                .add-form-grid   { gap:18px; }
