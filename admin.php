<?php
    ...
    // one item as-is; a wildcard match would cause a substring item to also
    // match an unrelated item that merely contains it.
    ...
    // in inventory.php / frame_management.php / customer.php), with a
    // fallback default if the row doesn't exist yet.
    $blockingTime = '20:30';
    ...
    // Approve New Staff Users and Manage User Roles each have their own
    // single tracked log label now, checked independently of each other.
    $approveUsersItems = ['APPROVE NEW STAFF USERS'];
    $approveUsersLocked = isAnyItemLogged($conn, $approveUsersItems) && $timeReached;

    $manageRolesItems = ['MANAGE USER ROLES'];
    $manageRolesLocked = isAnyItemLogged($conn, $manageRolesItems) && $timeReached;

    // System Configuration follows the same rule with its own tracked log label.
    $systemConfigItems = ['SYSTEM CONFIGURATION'];
    $systemConfigLocked = isAnyItemLogged($conn, $systemConfigItems) && $timeReached;
?>
            ...
            <div class="content-area">
                ...
                <div class="selection-container">
                    <div class="button-grid">
                        ...
                        <?php else: ?>
                            <button class="neu-button" data-url="approve_users.php" data-log-label="APPROVE NEW STAFF USERS" onclick="handleButtonClick(this)">
                                <span class="icon">✅</span>
                                Approve New Staff Users
                                <div class="led"></div>
                            </button>
                        ...
                        <?php else: ?>
                            <button class="neu-button" data-url="manage_roles.php" data-log-label="MANAGE USER ROLES" onclick="handleButtonClick(this)">
                                <span class="icon">🤝</span>
                                Manage User Roles
                                <div class="led"></div>
                            </button>
                        ...
                        <?php else: ?>
                            <button class="neu-button" data-url="system_config.php" data-log-label="SYSTEM CONFIGURATION" onclick="handleButtonClick(this)">
                                <span class="icon">⚙️</span>
                                System Configuration
                                <div class="led"></div>
                            </button>
