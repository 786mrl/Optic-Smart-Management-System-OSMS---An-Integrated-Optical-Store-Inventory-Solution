<?php
    ...
    // Approve New Staff Users and Manage User Roles share the same tracked
    // item, but are still checked independently of each other.
    $approveUsersItems = ['users'];
    $approveUsersLocked = isAnyItemLogged($conn, $approveUsersItems) && $timeReached;

    $manageRolesItems = ['users'];
    $manageRolesLocked = isAnyItemLogged($conn, $manageRolesItems) && $timeReached;

    // System Configuration only cares about the settings table item.
    $systemConfigItems = ['settings'];
            ...
            <div class="content-area">
                ...
                <div class="selection-container">
                    <div class="button-grid">
                        ...
                        <?php else: ?>
                            <button class="neu-button" data-url="approve_users.php" data-affected-items="users" onclick="handleButtonClick(this)">
                                <span class="icon">✅</span>
                                Approve New Staff Users
                                <div class="led"></div>
                            </button>
                        ...
                        <?php else: ?>
                            <button class="neu-button" data-url="manage_roles.php" data-affected-items="users" onclick="handleButtonClick(this)">
                                <span class="icon">🤝</span>
                                Manage User Roles
                                <div class="led"></div>
                            </button>
                        ...
                        <?php else: ?>
                            <button class="neu-button" data-url="system_config.php" data-affected-items="settings" onclick="handleButtonClick(this)">
                                <span class="icon">⚙️</span>
                                System Configuration
                                <div class="led"></div>
                            </button>
