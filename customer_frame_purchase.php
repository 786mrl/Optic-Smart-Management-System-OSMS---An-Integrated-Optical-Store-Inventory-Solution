...
<head>
    ...
    <style>
        ...
        /* ── PAGE-SPECIFIC OVERRIDE: reduce outer left/right gap ── */
        ...
        /* ── PAGE-SPECIFIC OVERRIDE: back button width fits its content ── */
        .btn-group .back-main {
            width: auto !important;
            display: inline-block !important;
        }

        /* ── PAGE-SPECIFIC: separate card wrapper for each collapsible section ── */
        .section-card {
            background: var(--bg-card);
            border-radius: 16px;
            padding: 18px 20px;
        ...
        .section-card .section-toggle-body {
            margin-top: 18px;
        }
    </style>
        ...
        <div class="content-area" style="flex-direction: column;">
            ...
            <div class="glass-window">
                ...
                <div class="section-toggle" onclick="toggleSection('analytics')">
                    <span class="toggle-icon closed" id="icon-analytics">▼</span>
                    <span>📊 Frame Sales Analytics</span>
                </div>

                <div id="analytics" class="section-toggle-body" style="display:none;">
                    ...
                    <div class="stat-bar">
                        ...
                        <div class="stat-card">
                            ...
                            <div class="stat-value" style="color:var(--accent-green); font-size:20px;">
                                IDR <?php echo number_format($stats['gross_revenue'] ?? 0, 0, ',', '.'); ?>
                            </div>
                        ...
                        <div class="stat-card">
                            ...
                            <div class="stat-value" style="color:var(--accent-blue); font-size:20px;">
                                IDR <?php echo number_format($stats['avg_frame_price'] ?? 0, 0, ',', '.'); ?>
                            </div>
                ...
                </div><!-- /section-card analytics -->

                <!-- ════════════════════════════════════ -->
                <!--  FILTER BAR                         -->
                <!-- ════════════════════════════════════ -->
                <div class="section-card">
                <div class="section-toggle" onclick="toggleSection('search-section')">
                    <span class="toggle-icon closed" id="icon-search-section">▼</span>
                    <span>🔍 Search &amp; Filter</span>
                </div>
                <div id="search-section" class="section-toggle-body" style="display:none;">
                <form method="GET" action="">
                    <div class="filter-bar">
                        <div style="flex-basis:100%; width:100%;">
                            <label>Search</label>
                            <input type="text" name="search" placeholder="Name / Invoice / UFC" style="width:100%;"
                        ...
                        <div style="flex-basis:100%; width:100%;">
                            ...
                            <select name="structure" style="width:100%;">
                        ...
                        <div style="flex-basis:100%; width:100%;">
                            <label>Month</label>
                            <input type="month" name="month" style="width:100%;" value="<?php echo htmlspecialchars($filter_month); ?>">
                        </div>
                        <div style="display:flex; gap:8px; align-items:flex-end; justify-content:center; flex-basis:100%; width:100%;">
                ...
                </div><!-- /section-card search -->

                <!-- ════════════════════════════════════ -->
                <!--  PURCHASE HISTORY TABLE             -->
                <!-- ════════════════════════════════════ -->
                <div class="section-card">
                <div class="section-toggle" onclick="toggleSection('history-section')">
                    <span class="toggle-icon closed" id="icon-history-section">▼</span>
                    <span>📋 Frame Purchase History</span>
                </div>
                <div id="history-section" class="section-toggle-body" style="display:none;">
                        ...
                        <table>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="amount-col">
                                        <div>IDR <?php echo number_format($row['total_amount'], 0, ',', '.'); ?></div>
                                    </td>
                                    <td class="amount-col">
                                        <div class="paid">IDR <?php echo number_format($row['amount_paid'], 0, ',', '.'); ?></div>
                                        <?php if ($sisa > 0): ?>
                                            <div class="unpaid">–IDR <?php echo number_format($sisa, 0, ',', '.'); ?></div>
                                        <?php endif; ?>
                                    </td>
                                    <td>
                        ...
                        tooltip: {
                            ...
                            callbacks: {
                                label: ctx => ctx.datasetIndex === 1
                                    ? 'IDR ' + parseInt(ctx.raw).toLocaleString('id-ID')
                                    : ctx.raw + ' orders'
                            }
                        }
                    },
